...
def repeats(our_str):
    """
    Функция repeats принимает
    на вход строку our_str
    и возвращает строку new_str
    :param our_str:
    :return: new_str
    """
    new_str = ""
    counter = dict.fromkeys(our_str[0: len(our_str)+1], 1)
    for i in our_str:
        new_str = new_str + str(i) + "_" + str(counter[i])
        counter[i] += 1
