...
def everything_for_your_cat(cats_data):
    """
    Функция принимает на вход переменную cats_data
    и выводит строку our_str
    :param cats_data:
    :return: our_str
    """
    result = []
    ...
    for i in cats_data:
        owner = i[2] + ' ' + i[3]
        cat_info = i[0] + ', ' + str(i[1])

        if owner not in owners:
            owners[owner] = []

        owners[owner].append(cat_info)

    for owner, cats in owners.items():
        owner_info = owner + ': ' + '; '.join(cats)  # cats - это value
