...
segment1 = Segment((2, 3), (4, 5))
print("Длина отрезка:", segment1.length())
print("Пересекает ли отрезок ось абсцисс:", segment1.x_axis_intersection())
print("Пересекает ли отрезок ось ординат:", segment1.y_axis_intersection())
